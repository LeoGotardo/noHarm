...
import { Icon, Btn, Card, Divider } from '@ui'
import { Screen, Header, EmptyState, hashHue, PersonRow, SegTabs } from '@components'
      ...
      <div style={{ padding: '16px 20px 0' }}>
        ...
        {enriched.length === 0 ? (
          <EmptyState
            ...
            action={<Btn kind="primary" onClick={onOpenSearch} icon="search">Find friends</Btn>}
          />
        ) : (
          <Card pad={6}>
            {enriched.map((f, i) => (
